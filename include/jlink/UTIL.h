...
int             UTIL_GetBitArrayValue         (const U8* p, U32 iBit);
...
void            UTIL_IPv6Addr2String          (SYS_SOCKET_ADDR6* pIPAddr, char* pBuffer, U32 BufferSize);
...
void            UTIL_InvBitArray              (U8 *p, U32 Off, int NumBits);
...
void            UTIL_Store16LEIncPtr          (U8** pp, U16 Data);
