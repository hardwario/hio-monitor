...
#define JLINK_EMU_PRODUCT_ID_FLASHER_SECURE            (0x24)
#define JLINK_EMU_PRODUCT_ID_JTRACE_PRO                (0x26)  // See JLINK_EMU_PRODUCT_ID_JTRACE_PRO_OLD
...
//
//#define JLINK_EMU_PRODUCT_ID_JTRACE_PRO_OLD     (0xFE)  // Old versions from
...
#define JLINK_DEV_FAMILY_XTENSA          0x16   // Tensilica/Cadence Xtensa related cores
...
#define JLINK_CORE_RX660            0x0D0FFFFF
// RX2xx sub family
...
#define JLINK_CORE_RX140            0x0D24FFFF
#define JLINK_CORE_RX13T            0x0D25FFFF
// RX64x sub family
...
//
// Tensilica/Cadence Xtensa related cores
// Keep [23:16] in line with DLL internal CPU_CORE_XTENSA_CPU_GENERATION enum!
//
//#define JLINK_CORE_XTENSA_III_CUSTOM            ((JLINK_DEV_FAMILY_XTENSA << 24) | 0x01 | 0x0000)  // Not supported
//#define JLINK_CORE_XTENSA_IV_CUSTOM             ((JLINK_DEV_FAMILY_XTENSA << 24) | 0x02 | 0x0000)  // Not supported
//#define JLINK_CORE_XTENSA_V_CUSTOM              ((JLINK_DEV_FAMILY_XTENSA << 24) | 0x03 | 0x0000)  // Not supported
#define JLINK_CORE_XTENSA_LX_CUSTOM             ((JLINK_DEV_FAMILY_XTENSA << 24) | (0x04 << 16) | 0x0000)
#define JLINK_CORE_XTENSA_HIFI1                 (JLINK_CORE_XTENSA_LX_CUSTOM                    | 0x0001)  // Always LX based but exact LX version depends on when core was synthesized
#define JLINK_CORE_XTENSA_HIFI3                 (JLINK_CORE_XTENSA_LX_CUSTOM                    | 0x0002)  // Always LX based but exact LX version depends on when core was synthesized
#define JLINK_CORE_XTENSA_HIFI3Z                (JLINK_CORE_XTENSA_LX_CUSTOM                    | 0x0003)  // Always LX based but exact LX version depends on when core was synthesized
#define JLINK_CORE_XTENSA_HIFI4                 (JLINK_CORE_XTENSA_LX_CUSTOM                    | 0x0004)  // Always LX based but exact LX version depends on when core was synthesized
#define JLINK_CORE_XTENSA_HIFI5                 (JLINK_CORE_XTENSA_LX_CUSTOM                    | 0x0005)  // Always LX based but exact LX version depends on when core was synthesized
//#define JLINK_CORE_XTENSA_FUSION_G3             (JLINK_CORE_XTENSA_LX_CUSTOM     | 0x000006)  // Not supported yet
//#define JLINK_CORE_XTENSA_FUSION_G6             (JLINK_CORE_XTENSA_LX_CUSTOM     | 0x000007)  // Not supported yet
#define JLINK_CORE_XTENSA_FUSION_F1             (JLINK_CORE_XTENSA_LX_CUSTOM     | 0x000008)  // Not supported yet
//#define JLINK_CORE_XTENSA_VISION_P1             (JLINK_CORE_XTENSA_LX_CUSTOM     | 0x000009)  // Not supported yet
//#define JLINK_CORE_XTENSA_VISION_P6             (JLINK_CORE_XTENSA_LX_CUSTOM     | 0x00000A)  // Not supported yet
//#define JLINK_CORE_XTENSA_NX_CUSTOM             ((JLINK_DEV_FAMILY_XTENSA << 24) | 0x05 | 0x0000)  // Not supported yet
...
#define JLINKARM_EMU_CAP_EX_SCHEDULE_REBOOT         (78)            // Supports schedule reboot command.
...
//
// BP mode flags for Cortex-M
//
// BP_MODE_ does not matter as there is only 1 CPU mode. Instruction size can be retrieved from opcode poattern.

//
// BP mode flags for Cortex-M SiLabs EFM8
//
// BP_MODE_ does not matter as there is only 1 CPU mode. Instruction size can be retrieved from opcode poattern.
//
...
#define JLINK_DEFAULT_FLASH_LOADER_NAME "Default"         // Name of default flash loader for a flash bank. Might be passed to some API functions / returned by some
...
typedef enum {
  ...
  // VPR:
  // Present only if ARMv8.1-M architecture and M-profile vector extension (MVE) is implemented.
  // This is NOT banked between security states, so there are no _S and _NS variants of this register.
  //
  // PAC registers:
  // Present only if ARMv8-M and PACBTI extension is implemented.
  //
  JLINKARM_CM3_REG_VPR,
  JLINKARM_CM3_REG_PAC_KEY_P_0,
  JLINKARM_CM3_REG_PAC_KEY_P_1,
  JLINKARM_CM3_REG_PAC_KEY_P_2,
  JLINKARM_CM3_REG_PAC_KEY_P_3,
  JLINKARM_CM3_REG_PAC_KEY_U_0,
  JLINKARM_CM3_REG_PAC_KEY_U_1,
  JLINKARM_CM3_REG_PAC_KEY_U_2,
  JLINKARM_CM3_REG_PAC_KEY_U_3,
  JLINKARM_CM3_REG_PAC_KEY_P_0_S,
  JLINKARM_CM3_REG_PAC_KEY_P_1_S,
  JLINKARM_CM3_REG_PAC_KEY_P_2_S,
  JLINKARM_CM3_REG_PAC_KEY_P_3_S,
  JLINKARM_CM3_REG_PAC_KEY_U_0_S,
  JLINKARM_CM3_REG_PAC_KEY_U_1_S,
  JLINKARM_CM3_REG_PAC_KEY_U_2_S,
  JLINKARM_CM3_REG_PAC_KEY_U_3_S,
  JLINKARM_CM3_REG_PAC_KEY_P_0_NS,
  JLINKARM_CM3_REG_PAC_KEY_P_1_NS,
  JLINKARM_CM3_REG_PAC_KEY_P_2_NS,
  JLINKARM_CM3_REG_PAC_KEY_P_3_NS,
  JLINKARM_CM3_REG_PAC_KEY_U_0_NS,
  JLINKARM_CM3_REG_PAC_KEY_U_1_NS,
  JLINKARM_CM3_REG_PAC_KEY_U_2_NS,
  JLINKARM_CM3_REG_PAC_KEY_U_3_NS,
...
typedef enum {
  ...
  JLINKARM_CM4_REG_BASEPRI_BASE0,           // (CFBP[15:8]  >>  8) & 0xFF
  JLINKARM_CM4_REG_FAULTMASK_BASE0,         // (CFBP[23:16] >> 16) & 0xFF
  JLINKARM_CM4_REG_CONTROL_BASE0,           // (CFBP[31:24] >> 24) & 0xFF
  JLINKARM_CM4_REG_BASEPRI_MAX_BASE0,       // (CFBP[15:8]  >>  8) & 0xFF
  // VPR:
  // Present only if ARMv8.1-M architecture and M-profile vector extension (MVE) is implemented.
  // This is NOT banked between security states, so there are no _S and _NS variants of this register.
  //
  ...
  // Present only if ARMv8-M and PACBTI extension is implemented.
  //
  JLINKARM_CM4_REG_VPR,
  JLINKARM_CM4_REG_PAC_KEY_P_0,
  JLINKARM_CM4_REG_PAC_KEY_P_1,
  JLINKARM_CM4_REG_PAC_KEY_P_2,
  JLINKARM_CM4_REG_PAC_KEY_P_3,
  JLINKARM_CM4_REG_PAC_KEY_U_0,
  JLINKARM_CM4_REG_PAC_KEY_U_1,
  JLINKARM_CM4_REG_PAC_KEY_U_2,
  JLINKARM_CM4_REG_PAC_KEY_U_3,
  JLINKARM_CM4_REG_PAC_KEY_P_0_S,
  JLINKARM_CM4_REG_PAC_KEY_P_1_S,
  JLINKARM_CM4_REG_PAC_KEY_P_2_S,
  JLINKARM_CM4_REG_PAC_KEY_P_3_S,
  JLINKARM_CM4_REG_PAC_KEY_U_0_S,
  JLINKARM_CM4_REG_PAC_KEY_U_1_S,
  JLINKARM_CM4_REG_PAC_KEY_U_2_S,
  JLINKARM_CM4_REG_PAC_KEY_U_3_S,
  JLINKARM_CM4_REG_PAC_KEY_P_0_NS,
  JLINKARM_CM4_REG_PAC_KEY_P_1_NS,
  JLINKARM_CM4_REG_PAC_KEY_P_2_NS,
  JLINKARM_CM4_REG_PAC_KEY_P_3_NS,
  JLINKARM_CM4_REG_PAC_KEY_U_0_NS,
  JLINKARM_CM4_REG_PAC_KEY_U_1_NS,
  JLINKARM_CM4_REG_PAC_KEY_U_2_NS,
  JLINKARM_CM4_REG_PAC_KEY_U_3_NS,
...
//
// JLINK_XTENSA_REG
// These need to match in order and index
// to the _aRegisterDescription table in CPU_CORE_XTENSA.c!
//
typedef enum {
  JLINK_XTENSA_REG_PC = 0,
  //
  // Standard "Address" Registers (16) of the currently active register window (determined by JLINK_XTENSA_REG_SPECIAL_WINDOWBASE)
  //
  JLINK_XTENSA_REG_A0 = 1,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A1 = 2,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A2 = 3,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A3 = 4,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A4 = 5,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A5 = 6,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A6 = 7,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A7 = 8,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A8 = 9,      // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A9 = 10,     // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A10 = 11,    // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A11 = 12,    // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A12 = 13,    // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A13 = 14,    // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A14 = 15,    // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  JLINK_XTENSA_REG_A15 = 16,    // Pseudo register, maps to one of REG_PHYSICAL_A0..64
  //
  // Physical address registers.
  // The core may implement 16, 32, 48 or 64 of these.
  // 16 continuous ones are always mapped to logical A0-A15 which are the ones the core instructions work with.
  // Currently active mapping depends on contents of JLINK_XTENSA_REG_SPECIAL_WINDOWBASE.
  //
  JLINK_XTENSA_REG_PHYSICAL_A0 = 17,
  JLINK_XTENSA_REG_PHYSICAL_A1 = 18,
  JLINK_XTENSA_REG_PHYSICAL_A2 = 19,
  JLINK_XTENSA_REG_PHYSICAL_A3 = 20,
  JLINK_XTENSA_REG_PHYSICAL_A4 = 21,
  JLINK_XTENSA_REG_PHYSICAL_A5 = 22,
  JLINK_XTENSA_REG_PHYSICAL_A6 = 23,
  JLINK_XTENSA_REG_PHYSICAL_A7 = 24,
  JLINK_XTENSA_REG_PHYSICAL_A8 = 25,
  JLINK_XTENSA_REG_PHYSICAL_A9 = 26,
  JLINK_XTENSA_REG_PHYSICAL_A10 = 27,
  JLINK_XTENSA_REG_PHYSICAL_A11 = 28,
  JLINK_XTENSA_REG_PHYSICAL_A12 = 29,
  JLINK_XTENSA_REG_PHYSICAL_A13 = 30,
  JLINK_XTENSA_REG_PHYSICAL_A14 = 31,
  JLINK_XTENSA_REG_PHYSICAL_A15 = 32,
  JLINK_XTENSA_REG_PHYSICAL_A16 = 33,
  JLINK_XTENSA_REG_PHYSICAL_A17 = 34,
  JLINK_XTENSA_REG_PHYSICAL_A18 = 35,
  JLINK_XTENSA_REG_PHYSICAL_A19 = 36,
  JLINK_XTENSA_REG_PHYSICAL_A20 = 37,
  JLINK_XTENSA_REG_PHYSICAL_A21 = 38,
  JLINK_XTENSA_REG_PHYSICAL_A22 = 39,
  JLINK_XTENSA_REG_PHYSICAL_A23 = 40,
  JLINK_XTENSA_REG_PHYSICAL_A24 = 41,
  JLINK_XTENSA_REG_PHYSICAL_A25 = 42,
  JLINK_XTENSA_REG_PHYSICAL_A26 = 43,
  JLINK_XTENSA_REG_PHYSICAL_A27 = 44,
  JLINK_XTENSA_REG_PHYSICAL_A28 = 45,
  JLINK_XTENSA_REG_PHYSICAL_A29 = 46,
  JLINK_XTENSA_REG_PHYSICAL_A30 = 47,
  JLINK_XTENSA_REG_PHYSICAL_A31 = 48,
  JLINK_XTENSA_REG_PHYSICAL_A32 = 49,
  JLINK_XTENSA_REG_PHYSICAL_A33 = 50,
  JLINK_XTENSA_REG_PHYSICAL_A34 = 51,
  JLINK_XTENSA_REG_PHYSICAL_A35 = 52,
  JLINK_XTENSA_REG_PHYSICAL_A36 = 53,
  JLINK_XTENSA_REG_PHYSICAL_A37 = 54,
  JLINK_XTENSA_REG_PHYSICAL_A38 = 55,
  JLINK_XTENSA_REG_PHYSICAL_A39 = 56,
  JLINK_XTENSA_REG_PHYSICAL_A40 = 57,
  JLINK_XTENSA_REG_PHYSICAL_A41 = 58,
  JLINK_XTENSA_REG_PHYSICAL_A42 = 59,
  JLINK_XTENSA_REG_PHYSICAL_A43 = 60,
  JLINK_XTENSA_REG_PHYSICAL_A44 = 61,
  JLINK_XTENSA_REG_PHYSICAL_A45 = 62,
  JLINK_XTENSA_REG_PHYSICAL_A46 = 63,
  JLINK_XTENSA_REG_PHYSICAL_A47 = 64,
  JLINK_XTENSA_REG_PHYSICAL_A48 = 65,
  JLINK_XTENSA_REG_PHYSICAL_A49 = 66,
  JLINK_XTENSA_REG_PHYSICAL_A50 = 67,
  JLINK_XTENSA_REG_PHYSICAL_A51 = 68,
  JLINK_XTENSA_REG_PHYSICAL_A52 = 69,
  JLINK_XTENSA_REG_PHYSICAL_A53 = 70,
  JLINK_XTENSA_REG_PHYSICAL_A54 = 71,
  JLINK_XTENSA_REG_PHYSICAL_A55 = 72,
  JLINK_XTENSA_REG_PHYSICAL_A56 = 73,
  JLINK_XTENSA_REG_PHYSICAL_A57 = 74,
  JLINK_XTENSA_REG_PHYSICAL_A58 = 75,
  JLINK_XTENSA_REG_PHYSICAL_A59 = 76,
  JLINK_XTENSA_REG_PHYSICAL_A60 = 77,
  JLINK_XTENSA_REG_PHYSICAL_A61 = 78,
  JLINK_XTENSA_REG_PHYSICAL_A62 = 79,
  JLINK_XTENSA_REG_PHYSICAL_A63 = 80,
  //
  // FPU registers
  //
  JLINK_XTENSA_REG_F0 = 81,
  JLINK_XTENSA_REG_F1 = 82,
  JLINK_XTENSA_REG_F2 = 83,
  JLINK_XTENSA_REG_F3 = 84,
  JLINK_XTENSA_REG_F4 = 85,
  JLINK_XTENSA_REG_F5 = 86,
  JLINK_XTENSA_REG_F6 = 87,
  JLINK_XTENSA_REG_F7 = 88,
  JLINK_XTENSA_REG_F8 = 89,
  JLINK_XTENSA_REG_F9 = 90,
  JLINK_XTENSA_REG_F10 = 91,
  JLINK_XTENSA_REG_F11 = 92,
  JLINK_XTENSA_REG_F12 = 93,
  JLINK_XTENSA_REG_F13 = 94,
  JLINK_XTENSA_REG_F14 = 95,
  JLINK_XTENSA_REG_F15 = 96,
  //
  // User Registers (up to 256)
  //
  JLINK_XTENSA_REG_USER0 = 97,
  JLINK_XTENSA_REG_USER1 = 98,
  JLINK_XTENSA_REG_USER2 = 99,
  JLINK_XTENSA_REG_USER3 = 100,
  JLINK_XTENSA_REG_USER4 = 101,
  JLINK_XTENSA_REG_USER5 = 102,
  JLINK_XTENSA_REG_USER6 = 103,
  JLINK_XTENSA_REG_USER7 = 104,
  JLINK_XTENSA_REG_USER8 = 105,
  JLINK_XTENSA_REG_USER9 = 106,
  JLINK_XTENSA_REG_USER10 = 107,
  JLINK_XTENSA_REG_USER11 = 108,
  JLINK_XTENSA_REG_USER12 = 109,
  JLINK_XTENSA_REG_USER13 = 110,
  JLINK_XTENSA_REG_USER14 = 111,
  JLINK_XTENSA_REG_USER15 = 112,
  JLINK_XTENSA_REG_USER16 = 113,
  JLINK_XTENSA_REG_USER17 = 114,
  JLINK_XTENSA_REG_USER18 = 115,
  JLINK_XTENSA_REG_USER19 = 116,
  JLINK_XTENSA_REG_USER20 = 117,
  JLINK_XTENSA_REG_USER21 = 118,
  JLINK_XTENSA_REG_USER22 = 119,
  JLINK_XTENSA_REG_USER23 = 120,
  JLINK_XTENSA_REG_USER24 = 121,
  JLINK_XTENSA_REG_USER25 = 122,
  JLINK_XTENSA_REG_USER26 = 123,
  JLINK_XTENSA_REG_USER27 = 124,
  JLINK_XTENSA_REG_USER28 = 125,
  JLINK_XTENSA_REG_USER29 = 126,
  JLINK_XTENSA_REG_USER30 = 127,
  JLINK_XTENSA_REG_USER31 = 128,
  JLINK_XTENSA_REG_USER32 = 129,
  JLINK_XTENSA_REG_USER33 = 130,
  JLINK_XTENSA_REG_USER34 = 131,
  JLINK_XTENSA_REG_USER35 = 132,
  JLINK_XTENSA_REG_USER36 = 133,
  JLINK_XTENSA_REG_USER37 = 134,
  JLINK_XTENSA_REG_USER38 = 135,
  JLINK_XTENSA_REG_USER39 = 136,
  JLINK_XTENSA_REG_USER40 = 137,
  JLINK_XTENSA_REG_USER41 = 138,
  JLINK_XTENSA_REG_USER42 = 139,
  JLINK_XTENSA_REG_USER43 = 140,
  JLINK_XTENSA_REG_USER44 = 141,
  JLINK_XTENSA_REG_USER45 = 142,
  JLINK_XTENSA_REG_USER46 = 143,
  JLINK_XTENSA_REG_USER47 = 144,
  JLINK_XTENSA_REG_USER48 = 145,
  JLINK_XTENSA_REG_USER49 = 146,
  JLINK_XTENSA_REG_USER50 = 147,
  JLINK_XTENSA_REG_USER51 = 148,
  JLINK_XTENSA_REG_USER52 = 149,
  JLINK_XTENSA_REG_USER53 = 150,
  JLINK_XTENSA_REG_USER54 = 151,
  JLINK_XTENSA_REG_USER55 = 152,
  JLINK_XTENSA_REG_USER56 = 153,
  JLINK_XTENSA_REG_USER57 = 154,
  JLINK_XTENSA_REG_USER58 = 155,
  JLINK_XTENSA_REG_USER59 = 156,
  JLINK_XTENSA_REG_USER60 = 157,
  JLINK_XTENSA_REG_USER61 = 158,
  JLINK_XTENSA_REG_USER62 = 159,
  JLINK_XTENSA_REG_USER63 = 160,
  JLINK_XTENSA_REG_USER64 = 161,
  JLINK_XTENSA_REG_USER65 = 162,
  JLINK_XTENSA_REG_USER66 = 163,
  JLINK_XTENSA_REG_USER67 = 164,
  JLINK_XTENSA_REG_USER68 = 165,
  JLINK_XTENSA_REG_USER69 = 166,
  JLINK_XTENSA_REG_USER70 = 167,
  JLINK_XTENSA_REG_USER71 = 168,
  JLINK_XTENSA_REG_USER72 = 169,
  JLINK_XTENSA_REG_USER73 = 170,
  JLINK_XTENSA_REG_USER74 = 171,
  JLINK_XTENSA_REG_USER75 = 172,
  JLINK_XTENSA_REG_USER76 = 173,
  JLINK_XTENSA_REG_USER77 = 174,
  JLINK_XTENSA_REG_USER78 = 175,
  JLINK_XTENSA_REG_USER79 = 176,
  JLINK_XTENSA_REG_USER80 = 177,
  JLINK_XTENSA_REG_USER81 = 178,
  JLINK_XTENSA_REG_USER82 = 179,
  JLINK_XTENSA_REG_USER83 = 180,
  JLINK_XTENSA_REG_USER84 = 181,
  JLINK_XTENSA_REG_USER85 = 182,
  JLINK_XTENSA_REG_USER86 = 183,
  JLINK_XTENSA_REG_USER87 = 184,
  JLINK_XTENSA_REG_USER88 = 185,
  JLINK_XTENSA_REG_USER89 = 186,
  JLINK_XTENSA_REG_USER90 = 187,
  JLINK_XTENSA_REG_USER91 = 188,
  JLINK_XTENSA_REG_USER92 = 189,
  JLINK_XTENSA_REG_USER93 = 190,
  JLINK_XTENSA_REG_USER94 = 191,
  JLINK_XTENSA_REG_USER95 = 192,
  JLINK_XTENSA_REG_USER96 = 193,
  JLINK_XTENSA_REG_USER97 = 194,
  JLINK_XTENSA_REG_USER98 = 195,
  JLINK_XTENSA_REG_USER99 = 196,
  JLINK_XTENSA_REG_USER100 = 197,
  JLINK_XTENSA_REG_USER101 = 198,
  JLINK_XTENSA_REG_USER102 = 199,
  JLINK_XTENSA_REG_USER103 = 200,
  JLINK_XTENSA_REG_USER104 = 201,
  JLINK_XTENSA_REG_USER105 = 202,
  JLINK_XTENSA_REG_USER106 = 203,
  JLINK_XTENSA_REG_USER107 = 204,
  JLINK_XTENSA_REG_USER108 = 205,
  JLINK_XTENSA_REG_USER109 = 206,
  JLINK_XTENSA_REG_USER110 = 207,
  JLINK_XTENSA_REG_USER111 = 208,
  JLINK_XTENSA_REG_USER112 = 209,
  JLINK_XTENSA_REG_USER113 = 210,
  JLINK_XTENSA_REG_USER114 = 211,
  JLINK_XTENSA_REG_USER115 = 212,
  JLINK_XTENSA_REG_USER116 = 213,
  JLINK_XTENSA_REG_USER117 = 214,
  JLINK_XTENSA_REG_USER118 = 215,
  JLINK_XTENSA_REG_USER119 = 216,
  JLINK_XTENSA_REG_USER120 = 217,
  JLINK_XTENSA_REG_USER121 = 218,
  JLINK_XTENSA_REG_USER122 = 219,
  JLINK_XTENSA_REG_USER123 = 220,
  JLINK_XTENSA_REG_USER124 = 221,
  JLINK_XTENSA_REG_USER125 = 222,
  JLINK_XTENSA_REG_USER126 = 223,
  JLINK_XTENSA_REG_USER127 = 224,
  JLINK_XTENSA_REG_USER128 = 225,
  JLINK_XTENSA_REG_USER129 = 226,
  JLINK_XTENSA_REG_USER130 = 227,
  JLINK_XTENSA_REG_USER131 = 228,
  JLINK_XTENSA_REG_USER132 = 229,
  JLINK_XTENSA_REG_USER133 = 230,
  JLINK_XTENSA_REG_USER134 = 231,
  JLINK_XTENSA_REG_USER135 = 232,
  JLINK_XTENSA_REG_USER136 = 233,
  JLINK_XTENSA_REG_USER137 = 234,
  JLINK_XTENSA_REG_USER138 = 235,
  JLINK_XTENSA_REG_USER139 = 236,
  JLINK_XTENSA_REG_USER140 = 237,
  JLINK_XTENSA_REG_USER141 = 238,
  JLINK_XTENSA_REG_USER142 = 239,
  JLINK_XTENSA_REG_USER143 = 240,
  JLINK_XTENSA_REG_USER144 = 241,
  JLINK_XTENSA_REG_USER145 = 242,
  JLINK_XTENSA_REG_USER146 = 243,
  JLINK_XTENSA_REG_USER147 = 244,
  JLINK_XTENSA_REG_USER148 = 245,
  JLINK_XTENSA_REG_USER149 = 246,
  JLINK_XTENSA_REG_USER150 = 247,
  JLINK_XTENSA_REG_USER151 = 248,
  JLINK_XTENSA_REG_USER152 = 249,
  JLINK_XTENSA_REG_USER153 = 250,
  JLINK_XTENSA_REG_USER154 = 251,
  JLINK_XTENSA_REG_USER155 = 252,
  JLINK_XTENSA_REG_USER156 = 253,
  JLINK_XTENSA_REG_USER157 = 254,
  JLINK_XTENSA_REG_USER158 = 255,
  JLINK_XTENSA_REG_USER159 = 256,
  JLINK_XTENSA_REG_USER160 = 257,
  JLINK_XTENSA_REG_USER161 = 258,
  JLINK_XTENSA_REG_USER162 = 259,
  JLINK_XTENSA_REG_USER163 = 260,
  JLINK_XTENSA_REG_USER164 = 261,
  JLINK_XTENSA_REG_USER165 = 262,
  JLINK_XTENSA_REG_USER166 = 263,
  JLINK_XTENSA_REG_USER167 = 264,
  JLINK_XTENSA_REG_USER168 = 265,
  JLINK_XTENSA_REG_USER169 = 266,
  JLINK_XTENSA_REG_USER170 = 267,
  JLINK_XTENSA_REG_USER171 = 268,
  JLINK_XTENSA_REG_USER172 = 269,
  JLINK_XTENSA_REG_USER173 = 270,
  JLINK_XTENSA_REG_USER174 = 271,
  JLINK_XTENSA_REG_USER175 = 272,
  JLINK_XTENSA_REG_USER176 = 273,
  JLINK_XTENSA_REG_USER177 = 274,
  JLINK_XTENSA_REG_USER178 = 275,
  JLINK_XTENSA_REG_USER179 = 276,
  JLINK_XTENSA_REG_USER180 = 277,
  JLINK_XTENSA_REG_USER181 = 278,
  JLINK_XTENSA_REG_USER182 = 279,
  JLINK_XTENSA_REG_USER183 = 280,
  JLINK_XTENSA_REG_USER184 = 281,
  JLINK_XTENSA_REG_USER185 = 282,
  JLINK_XTENSA_REG_USER186 = 283,
  JLINK_XTENSA_REG_USER187 = 284,
  JLINK_XTENSA_REG_USER188 = 285,
  JLINK_XTENSA_REG_USER189 = 286,
  JLINK_XTENSA_REG_USER190 = 287,
  JLINK_XTENSA_REG_USER191 = 288,
  JLINK_XTENSA_REG_USER192 = 289,
  JLINK_XTENSA_REG_USER193 = 290,
  JLINK_XTENSA_REG_USER194 = 291,
  JLINK_XTENSA_REG_USER195 = 292,
  JLINK_XTENSA_REG_USER196 = 293,
  JLINK_XTENSA_REG_USER197 = 294,
  JLINK_XTENSA_REG_USER198 = 295,
  JLINK_XTENSA_REG_USER199 = 296,
  JLINK_XTENSA_REG_USER200 = 297,
  JLINK_XTENSA_REG_USER201 = 298,
  JLINK_XTENSA_REG_USER202 = 299,
  JLINK_XTENSA_REG_USER203 = 300,
  JLINK_XTENSA_REG_USER204 = 301,
  JLINK_XTENSA_REG_USER205 = 302,
  JLINK_XTENSA_REG_USER206 = 303,
  JLINK_XTENSA_REG_USER207 = 304,
  JLINK_XTENSA_REG_USER208 = 305,
  JLINK_XTENSA_REG_USER209 = 306,
  JLINK_XTENSA_REG_USER210 = 307,
  JLINK_XTENSA_REG_USER211 = 308,
  JLINK_XTENSA_REG_USER212 = 309,
  JLINK_XTENSA_REG_USER213 = 310,
  JLINK_XTENSA_REG_USER214 = 311,
  JLINK_XTENSA_REG_USER215 = 312,
  JLINK_XTENSA_REG_USER216 = 313,
  JLINK_XTENSA_REG_USER217 = 314,
  JLINK_XTENSA_REG_USER218 = 315,
  JLINK_XTENSA_REG_USER219 = 316,
  JLINK_XTENSA_REG_USER220 = 317,
  JLINK_XTENSA_REG_USER221 = 318,
  JLINK_XTENSA_REG_USER222 = 319,
  JLINK_XTENSA_REG_USER223 = 320,
  JLINK_XTENSA_REG_USER224 = 321,
  JLINK_XTENSA_REG_USER225 = 322,
  JLINK_XTENSA_REG_USER226 = 323,
  JLINK_XTENSA_REG_USER227 = 324,
  JLINK_XTENSA_REG_USER228 = 325,
  JLINK_XTENSA_REG_USER229 = 326,
  JLINK_XTENSA_REG_USER230 = 327,
  JLINK_XTENSA_REG_USER231 = 328,
  JLINK_XTENSA_REG_USER232 = 329,
  JLINK_XTENSA_REG_USER233 = 330,
  JLINK_XTENSA_REG_USER234 = 331,
  JLINK_XTENSA_REG_USER235 = 332,
  JLINK_XTENSA_REG_USER236 = 333,
  JLINK_XTENSA_REG_USER237 = 334,
  JLINK_XTENSA_REG_USER238 = 335,
  JLINK_XTENSA_REG_USER239 = 336,
  JLINK_XTENSA_REG_USER240 = 337,
  JLINK_XTENSA_REG_USER241 = 338,
  JLINK_XTENSA_REG_USER242 = 339,
  JLINK_XTENSA_REG_USER243 = 340,
  JLINK_XTENSA_REG_USER244 = 341,
  JLINK_XTENSA_REG_USER245 = 342,
  JLINK_XTENSA_REG_USER246 = 343,
  JLINK_XTENSA_REG_USER247 = 344,
  JLINK_XTENSA_REG_USER248 = 345,
  JLINK_XTENSA_REG_USER249 = 346,
  JLINK_XTENSA_REG_USER250 = 347,
  JLINK_XTENSA_REG_USER251 = 348,
  JLINK_XTENSA_REG_USER252 = 349,
  JLINK_XTENSA_REG_USER253 = 350,
  JLINK_XTENSA_REG_USER254 = 351,
  JLINK_XTENSA_REG_USER255 = 352,
  //
  // Special Registers (up to 256)
  //
  JLINK_XTENSA_REG_SPECIAL0 = 353,
  JLINK_XTENSA_REG_SPECIAL1 = 354,
  JLINK_XTENSA_REG_SPECIAL2 = 355,
  JLINK_XTENSA_REG_SPECIAL3 = 356,
  JLINK_XTENSA_REG_SPECIAL4 = 357,
  JLINK_XTENSA_REG_SPECIAL5 = 358,
  JLINK_XTENSA_REG_SPECIAL6 = 359,
  JLINK_XTENSA_REG_SPECIAL7 = 360,
  JLINK_XTENSA_REG_SPECIAL8 = 361,
  JLINK_XTENSA_REG_SPECIAL9 = 362,
  JLINK_XTENSA_REG_SPECIAL10 = 363,
  JLINK_XTENSA_REG_SPECIAL11 = 364,
  JLINK_XTENSA_REG_SPECIAL12 = 365,
  JLINK_XTENSA_REG_SPECIAL13 = 366,
  JLINK_XTENSA_REG_SPECIAL14 = 367,
  JLINK_XTENSA_REG_SPECIAL15 = 368,
  JLINK_XTENSA_REG_SPECIAL16 = 369,
  JLINK_XTENSA_REG_SPECIAL17 = 370,
  JLINK_XTENSA_REG_SPECIAL18 = 371,
  JLINK_XTENSA_REG_SPECIAL19 = 372,
  JLINK_XTENSA_REG_SPECIAL20 = 373,
  JLINK_XTENSA_REG_SPECIAL21 = 374,
  JLINK_XTENSA_REG_SPECIAL22 = 375,
  JLINK_XTENSA_REG_SPECIAL23 = 376,
  JLINK_XTENSA_REG_SPECIAL24 = 377,
  JLINK_XTENSA_REG_SPECIAL25 = 378,
  JLINK_XTENSA_REG_SPECIAL26 = 379,
  JLINK_XTENSA_REG_SPECIAL27 = 380,
  JLINK_XTENSA_REG_SPECIAL28 = 381,
  JLINK_XTENSA_REG_SPECIAL29 = 382,
  JLINK_XTENSA_REG_SPECIAL30 = 383,
  JLINK_XTENSA_REG_SPECIAL31 = 384,
  JLINK_XTENSA_REG_SPECIAL32 = 385,
  JLINK_XTENSA_REG_SPECIAL33 = 386,
  JLINK_XTENSA_REG_SPECIAL34 = 387,
  JLINK_XTENSA_REG_SPECIAL35 = 388,
  JLINK_XTENSA_REG_SPECIAL36 = 389,
  JLINK_XTENSA_REG_SPECIAL37 = 390,
  JLINK_XTENSA_REG_SPECIAL38 = 391,
  JLINK_XTENSA_REG_SPECIAL39 = 392,
  JLINK_XTENSA_REG_SPECIAL40 = 393,
  JLINK_XTENSA_REG_SPECIAL41 = 394,
  JLINK_XTENSA_REG_SPECIAL42 = 395,
  JLINK_XTENSA_REG_SPECIAL43 = 396,
  JLINK_XTENSA_REG_SPECIAL44 = 397,
  JLINK_XTENSA_REG_SPECIAL45 = 398,
  JLINK_XTENSA_REG_SPECIAL46 = 399,
  JLINK_XTENSA_REG_SPECIAL47 = 400,
  JLINK_XTENSA_REG_SPECIAL48 = 401,
  JLINK_XTENSA_REG_SPECIAL49 = 402,
  JLINK_XTENSA_REG_SPECIAL50 = 403,
  JLINK_XTENSA_REG_SPECIAL51 = 404,
  JLINK_XTENSA_REG_SPECIAL52 = 405,
  JLINK_XTENSA_REG_SPECIAL53 = 406,
  JLINK_XTENSA_REG_SPECIAL54 = 407,
  JLINK_XTENSA_REG_SPECIAL55 = 408,
  JLINK_XTENSA_REG_SPECIAL56 = 409,
  JLINK_XTENSA_REG_SPECIAL57 = 410,
  JLINK_XTENSA_REG_SPECIAL58 = 411,
  JLINK_XTENSA_REG_SPECIAL59 = 412,
  JLINK_XTENSA_REG_SPECIAL60 = 413,
  JLINK_XTENSA_REG_SPECIAL61 = 414,
  JLINK_XTENSA_REG_SPECIAL62 = 415,
  JLINK_XTENSA_REG_SPECIAL63 = 416,
  JLINK_XTENSA_REG_SPECIAL64 = 417,
  JLINK_XTENSA_REG_SPECIAL65 = 418,
  JLINK_XTENSA_REG_SPECIAL66 = 419,
  JLINK_XTENSA_REG_SPECIAL67 = 420,
  JLINK_XTENSA_REG_SPECIAL68 = 421,
  JLINK_XTENSA_REG_SPECIAL69 = 422,
  JLINK_XTENSA_REG_SPECIAL70 = 423,
  JLINK_XTENSA_REG_SPECIAL71 = 424,
  JLINK_XTENSA_REG_SPECIAL72 = 425,
  JLINK_XTENSA_REG_SPECIAL73 = 426,
  JLINK_XTENSA_REG_SPECIAL74 = 427,
  JLINK_XTENSA_REG_SPECIAL75 = 428,
  JLINK_XTENSA_REG_SPECIAL76 = 429,
  JLINK_XTENSA_REG_SPECIAL77 = 430,
  JLINK_XTENSA_REG_SPECIAL78 = 431,
  JLINK_XTENSA_REG_SPECIAL79 = 432,
  JLINK_XTENSA_REG_SPECIAL80 = 433,
  JLINK_XTENSA_REG_SPECIAL81 = 434,
  JLINK_XTENSA_REG_SPECIAL82 = 435,
  JLINK_XTENSA_REG_SPECIAL83 = 436,
  JLINK_XTENSA_REG_SPECIAL84 = 437,
  JLINK_XTENSA_REG_SPECIAL85 = 438,
  JLINK_XTENSA_REG_SPECIAL86 = 439,
  JLINK_XTENSA_REG_SPECIAL87 = 440,
  JLINK_XTENSA_REG_SPECIAL88 = 441,
  JLINK_XTENSA_REG_SPECIAL89 = 442,
  JLINK_XTENSA_REG_SPECIAL90 = 443,
  JLINK_XTENSA_REG_SPECIAL91 = 444,
  JLINK_XTENSA_REG_SPECIAL92 = 445,
  JLINK_XTENSA_REG_SPECIAL93 = 446,
  JLINK_XTENSA_REG_SPECIAL94 = 447,
  JLINK_XTENSA_REG_SPECIAL95 = 448,
  JLINK_XTENSA_REG_SPECIAL96 = 449,
  JLINK_XTENSA_REG_SPECIAL97 = 450,
  JLINK_XTENSA_REG_SPECIAL98 = 451,
  JLINK_XTENSA_REG_SPECIAL99 = 452,
  JLINK_XTENSA_REG_SPECIAL100 = 453,
  JLINK_XTENSA_REG_SPECIAL101 = 454,
  JLINK_XTENSA_REG_SPECIAL102 = 455,
  JLINK_XTENSA_REG_SPECIAL103 = 456,
  JLINK_XTENSA_REG_SPECIAL104 = 457,
  JLINK_XTENSA_REG_SPECIAL105 = 458,
  JLINK_XTENSA_REG_SPECIAL106 = 459,
  JLINK_XTENSA_REG_SPECIAL107 = 460,
  JLINK_XTENSA_REG_SPECIAL108 = 461,
  JLINK_XTENSA_REG_SPECIAL109 = 462,
  JLINK_XTENSA_REG_SPECIAL110 = 463,
  JLINK_XTENSA_REG_SPECIAL111 = 464,
  JLINK_XTENSA_REG_SPECIAL112 = 465,
  JLINK_XTENSA_REG_SPECIAL113 = 466,
  JLINK_XTENSA_REG_SPECIAL114 = 467,
  JLINK_XTENSA_REG_SPECIAL115 = 468,
  JLINK_XTENSA_REG_SPECIAL116 = 469,
  JLINK_XTENSA_REG_SPECIAL117 = 470,
  JLINK_XTENSA_REG_SPECIAL118 = 471,
  JLINK_XTENSA_REG_SPECIAL119 = 472,
  JLINK_XTENSA_REG_SPECIAL120 = 473,
  JLINK_XTENSA_REG_SPECIAL121 = 474,
  JLINK_XTENSA_REG_SPECIAL122 = 475,
  JLINK_XTENSA_REG_SPECIAL123 = 476,
  JLINK_XTENSA_REG_SPECIAL124 = 477,
  JLINK_XTENSA_REG_SPECIAL125 = 478,
  JLINK_XTENSA_REG_SPECIAL126 = 479,
  JLINK_XTENSA_REG_SPECIAL127 = 480,
  JLINK_XTENSA_REG_SPECIAL128 = 481,
  JLINK_XTENSA_REG_SPECIAL129 = 482,
  JLINK_XTENSA_REG_SPECIAL130 = 483,
  JLINK_XTENSA_REG_SPECIAL131 = 484,
  JLINK_XTENSA_REG_SPECIAL132 = 485,
  JLINK_XTENSA_REG_SPECIAL133 = 486,
  JLINK_XTENSA_REG_SPECIAL134 = 487,
  JLINK_XTENSA_REG_SPECIAL135 = 488,
  JLINK_XTENSA_REG_SPECIAL136 = 489,
  JLINK_XTENSA_REG_SPECIAL137 = 490,
  JLINK_XTENSA_REG_SPECIAL138 = 491,
  JLINK_XTENSA_REG_SPECIAL139 = 492,
  JLINK_XTENSA_REG_SPECIAL140 = 493,
  JLINK_XTENSA_REG_SPECIAL141 = 494,
  JLINK_XTENSA_REG_SPECIAL142 = 495,
  JLINK_XTENSA_REG_SPECIAL143 = 496,
  JLINK_XTENSA_REG_SPECIAL144 = 497,
  JLINK_XTENSA_REG_SPECIAL145 = 498,
  JLINK_XTENSA_REG_SPECIAL146 = 499,
  JLINK_XTENSA_REG_SPECIAL147 = 500,
  JLINK_XTENSA_REG_SPECIAL148 = 501,
  JLINK_XTENSA_REG_SPECIAL149 = 502,
  JLINK_XTENSA_REG_SPECIAL150 = 503,
  JLINK_XTENSA_REG_SPECIAL151 = 504,
  JLINK_XTENSA_REG_SPECIAL152 = 505,
  JLINK_XTENSA_REG_SPECIAL153 = 506,
  JLINK_XTENSA_REG_SPECIAL154 = 507,
  JLINK_XTENSA_REG_SPECIAL155 = 508,
  JLINK_XTENSA_REG_SPECIAL156 = 509,
  JLINK_XTENSA_REG_SPECIAL157 = 510,
  JLINK_XTENSA_REG_SPECIAL158 = 511,
  JLINK_XTENSA_REG_SPECIAL159 = 512,
  JLINK_XTENSA_REG_SPECIAL160 = 513,
  JLINK_XTENSA_REG_SPECIAL161 = 514,
  JLINK_XTENSA_REG_SPECIAL162 = 515,
  JLINK_XTENSA_REG_SPECIAL163 = 516,
  JLINK_XTENSA_REG_SPECIAL164 = 517,
  JLINK_XTENSA_REG_SPECIAL165 = 518,
  JLINK_XTENSA_REG_SPECIAL166 = 519,
  JLINK_XTENSA_REG_SPECIAL167 = 520,
  JLINK_XTENSA_REG_SPECIAL168 = 521,
  JLINK_XTENSA_REG_SPECIAL169 = 522,
  JLINK_XTENSA_REG_SPECIAL170 = 523,
  JLINK_XTENSA_REG_SPECIAL171 = 524,
  JLINK_XTENSA_REG_SPECIAL172 = 525,
  JLINK_XTENSA_REG_SPECIAL173 = 526,
  JLINK_XTENSA_REG_SPECIAL174 = 527,
  JLINK_XTENSA_REG_SPECIAL175 = 528,
  JLINK_XTENSA_REG_SPECIAL176 = 529,
  JLINK_XTENSA_REG_SPECIAL177 = 530,
  JLINK_XTENSA_REG_SPECIAL178 = 531,
  JLINK_XTENSA_REG_SPECIAL179 = 532,
  JLINK_XTENSA_REG_SPECIAL180 = 533,
  JLINK_XTENSA_REG_SPECIAL181 = 534,
  JLINK_XTENSA_REG_SPECIAL182 = 535,
  JLINK_XTENSA_REG_SPECIAL183 = 536,
  JLINK_XTENSA_REG_SPECIAL184 = 537,
  JLINK_XTENSA_REG_SPECIAL185 = 538,
  JLINK_XTENSA_REG_SPECIAL186 = 539,
  JLINK_XTENSA_REG_SPECIAL187 = 540,
  JLINK_XTENSA_REG_SPECIAL188 = 541,
  JLINK_XTENSA_REG_SPECIAL189 = 542,
  JLINK_XTENSA_REG_SPECIAL190 = 543,
  JLINK_XTENSA_REG_SPECIAL191 = 544,
  JLINK_XTENSA_REG_SPECIAL192 = 545,
  JLINK_XTENSA_REG_SPECIAL193 = 546,
  JLINK_XTENSA_REG_SPECIAL194 = 547,
  JLINK_XTENSA_REG_SPECIAL195 = 548,
  JLINK_XTENSA_REG_SPECIAL196 = 549,
  JLINK_XTENSA_REG_SPECIAL197 = 550,
  JLINK_XTENSA_REG_SPECIAL198 = 551,
  JLINK_XTENSA_REG_SPECIAL199 = 552,
  JLINK_XTENSA_REG_SPECIAL200 = 553,
  JLINK_XTENSA_REG_SPECIAL201 = 554,
  JLINK_XTENSA_REG_SPECIAL202 = 555,
  JLINK_XTENSA_REG_SPECIAL203 = 556,
  JLINK_XTENSA_REG_SPECIAL204 = 557,
  JLINK_XTENSA_REG_SPECIAL205 = 558,
  JLINK_XTENSA_REG_SPECIAL206 = 559,
  JLINK_XTENSA_REG_SPECIAL207 = 560,
  JLINK_XTENSA_REG_SPECIAL208 = 561,
  JLINK_XTENSA_REG_SPECIAL209 = 562,
  JLINK_XTENSA_REG_SPECIAL210 = 563,
  JLINK_XTENSA_REG_SPECIAL211 = 564,
  JLINK_XTENSA_REG_SPECIAL212 = 565,
  JLINK_XTENSA_REG_SPECIAL213 = 566,
  JLINK_XTENSA_REG_SPECIAL214 = 567,
  JLINK_XTENSA_REG_SPECIAL215 = 568,
  JLINK_XTENSA_REG_SPECIAL216 = 569,
  JLINK_XTENSA_REG_SPECIAL217 = 570,
  JLINK_XTENSA_REG_SPECIAL218 = 571,
  JLINK_XTENSA_REG_SPECIAL219 = 572,
  JLINK_XTENSA_REG_SPECIAL220 = 573,
  JLINK_XTENSA_REG_SPECIAL221 = 574,
  JLINK_XTENSA_REG_SPECIAL222 = 575,
  JLINK_XTENSA_REG_SPECIAL223 = 576,
  JLINK_XTENSA_REG_SPECIAL224 = 577,
  JLINK_XTENSA_REG_SPECIAL225 = 578,
  JLINK_XTENSA_REG_SPECIAL226 = 579,
  JLINK_XTENSA_REG_SPECIAL227 = 580,
  JLINK_XTENSA_REG_SPECIAL228 = 581,
  JLINK_XTENSA_REG_SPECIAL229 = 582,
  JLINK_XTENSA_REG_SPECIAL230 = 583,
  JLINK_XTENSA_REG_SPECIAL231 = 584,
  JLINK_XTENSA_REG_SPECIAL232 = 585,
  JLINK_XTENSA_REG_SPECIAL233 = 586,
  JLINK_XTENSA_REG_SPECIAL234 = 587,
  JLINK_XTENSA_REG_SPECIAL235 = 588,
  JLINK_XTENSA_REG_SPECIAL236 = 589,
  JLINK_XTENSA_REG_SPECIAL237 = 590,
  JLINK_XTENSA_REG_SPECIAL238 = 591,
  JLINK_XTENSA_REG_SPECIAL239 = 592,
  JLINK_XTENSA_REG_SPECIAL240 = 593,
  JLINK_XTENSA_REG_SPECIAL241 = 594,
  JLINK_XTENSA_REG_SPECIAL242 = 595,
  JLINK_XTENSA_REG_SPECIAL243 = 596,
  JLINK_XTENSA_REG_SPECIAL244 = 597,
  JLINK_XTENSA_REG_SPECIAL245 = 598,
  JLINK_XTENSA_REG_SPECIAL246 = 599,
  JLINK_XTENSA_REG_SPECIAL247 = 600,
  JLINK_XTENSA_REG_SPECIAL248 = 601,
  JLINK_XTENSA_REG_SPECIAL249 = 602,
  JLINK_XTENSA_REG_SPECIAL250 = 603,
  JLINK_XTENSA_REG_SPECIAL251 = 604,
  JLINK_XTENSA_REG_SPECIAL252 = 605,
  JLINK_XTENSA_REG_SPECIAL253 = 606,
  JLINK_XTENSA_REG_SPECIAL254 = 607,
  JLINK_XTENSA_REG_SPECIAL255 = 608,
  //
  // Boolean registers
  // These are an alias for bits 0..15 of JLINK_XTENSA_REG_SPECIAL_BR
  //
  JLINK_XTENSA_REG_B0 = 609,    // Pseudo register, maps to bit  0 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B1 = 610,    // Pseudo register, maps to bit  1 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B2 = 611,    // Pseudo register, maps to bit  2 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B3 = 612,    // Pseudo register, maps to bit  3 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B4 = 613,    // Pseudo register, maps to bit  4 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B5 = 614,    // Pseudo register, maps to bit  5 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B6 = 615,    // Pseudo register, maps to bit  6 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B7 = 616,    // Pseudo register, maps to bit  7 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B8 = 617,    // Pseudo register, maps to bit  8 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B9 = 618,    // Pseudo register, maps to bit  9 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B10 = 619,   // Pseudo register, maps to bit 10 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B11 = 620,   // Pseudo register, maps to bit 11 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B12 = 621,   // Pseudo register, maps to bit 12 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B13 = 622,   // Pseudo register, maps to bit 13 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B14 = 623,   // Pseudo register, maps to bit 14 in REG_SPECIAL_BR
  JLINK_XTENSA_REG_B15 = 624,   // Pseudo register, maps to bit 15 in REG_SPECIAL_BR
  JLINK_XTENSA_NUM_REGS
} JLINK_XTENSA_REG;
//
// Alternate defines for certain user registers (S0-S255) that have a descriptive name,
// to make J-Link-internal code more readable.
//
#define JLINK_XTENSA_REG_USER_THREADPTR JLINK_XTENSA_REG_USER231
#define JLINK_XTENSA_REG_USER_FCR       JLINK_XTENSA_REG_USER232
#define JLINK_XTENSA_REG_USER_FSR       JLINK_XTENSA_REG_USER233
//
// Alternate defines for certain special registers (S0-S255) that have a descriptive name,
// to make J-Link-internal code more readable.
//
#define JLINK_XTENSA_REG_SPECIAL_LBEG         JLINK_XTENSA_REG_SPECIAL0
#define JLINK_XTENSA_REG_SPECIAL_LEND         JLINK_XTENSA_REG_SPECIAL1
#define JLINK_XTENSA_REG_SPECIAL_LCOUNT       JLINK_XTENSA_REG_SPECIAL2
#define JLINK_XTENSA_REG_SPECIAL_SAR          JLINK_XTENSA_REG_SPECIAL3
#define JLINK_XTENSA_REG_SPECIAL_BR           JLINK_XTENSA_REG_SPECIAL4
#define JLINK_XTENSA_REG_SPECIAL_LITBASE      JLINK_XTENSA_REG_SPECIAL5
#define JLINK_XTENSA_REG_SPECIAL_SCOMPARE1    JLINK_XTENSA_REG_SPECIAL12
#define JLINK_XTENSA_REG_SPECIAL_ACCLO        JLINK_XTENSA_REG_SPECIAL16
#define JLINK_XTENSA_REG_SPECIAL_ACCHI        JLINK_XTENSA_REG_SPECIAL17
#define JLINK_XTENSA_REG_SPECIAL_M0           JLINK_XTENSA_REG_SPECIAL32
#define JLINK_XTENSA_REG_SPECIAL_M1           JLINK_XTENSA_REG_SPECIAL33
#define JLINK_XTENSA_REG_SPECIAL_M2           JLINK_XTENSA_REG_SPECIAL34
#define JLINK_XTENSA_REG_SPECIAL_M3           JLINK_XTENSA_REG_SPECIAL35
#define JLINK_XTENSA_REG_SPECIAL_PREFCTL      JLINK_XTENSA_REG_SPECIAL40
#define JLINK_XTENSA_REG_SPECIAL_WINDOWBASE   JLINK_XTENSA_REG_SPECIAL72
#define JLINK_XTENSA_REG_SPECIAL_WINDOWSTART  JLINK_XTENSA_REG_SPECIAL73
#define JLINK_XTENSA_REG_SPECIAL_PTEVADDR     JLINK_XTENSA_REG_SPECIAL83
#define JLINK_XTENSA_REG_SPECIAL_MMID         JLINK_XTENSA_REG_SPECIAL89
#define JLINK_XTENSA_REG_SPECIAL_RASID        JLINK_XTENSA_REG_SPECIAL90
#define JLINK_XTENSA_REG_SPECIAL_ITLBCFG      JLINK_XTENSA_REG_SPECIAL91
#define JLINK_XTENSA_REG_SPECIAL_DTLBCFG      JLINK_XTENSA_REG_SPECIAL92
#define JLINK_XTENSA_REG_SPECIAL_IBREAKENABLE JLINK_XTENSA_REG_SPECIAL96
#define JLINK_XTENSA_REG_SPECIAL_MEMCTL       JLINK_XTENSA_REG_SPECIAL97
#define JLINK_XTENSA_REG_SPECIAL_CACHEATTR    JLINK_XTENSA_REG_SPECIAL98
#define JLINK_XTENSA_REG_SPECIAL_ATOMCTL      JLINK_XTENSA_REG_SPECIAL99
#define JLINK_XTENSA_REG_SPECIAL_DDR          JLINK_XTENSA_REG_SPECIAL104
#define JLINK_XTENSA_REG_SPECIAL_MEPC         JLINK_XTENSA_REG_SPECIAL106
#define JLINK_XTENSA_REG_SPECIAL_MEPS         JLINK_XTENSA_REG_SPECIAL107
#define JLINK_XTENSA_REG_SPECIAL_MESAVE       JLINK_XTENSA_REG_SPECIAL108
#define JLINK_XTENSA_REG_SPECIAL_MESR         JLINK_XTENSA_REG_SPECIAL109
#define JLINK_XTENSA_REG_SPECIAL_MECR         JLINK_XTENSA_REG_SPECIAL110
#define JLINK_XTENSA_REG_SPECIAL_MEVADDR      JLINK_XTENSA_REG_SPECIAL111
#define JLINK_XTENSA_REG_SPECIAL_IBREAKA0     JLINK_XTENSA_REG_SPECIAL128
#define JLINK_XTENSA_REG_SPECIAL_IBREAKA1     JLINK_XTENSA_REG_SPECIAL129
#define JLINK_XTENSA_REG_SPECIAL_DBREAKA0     JLINK_XTENSA_REG_SPECIAL144
#define JLINK_XTENSA_REG_SPECIAL_DBREAKA1     JLINK_XTENSA_REG_SPECIAL145
#define JLINK_XTENSA_REG_SPECIAL_DBREAKC0     JLINK_XTENSA_REG_SPECIAL160
#define JLINK_XTENSA_REG_SPECIAL_DBREAKC1     JLINK_XTENSA_REG_SPECIAL161
#define JLINK_XTENSA_REG_SPECIAL_HWCONFIG_ID0 JLINK_XTENSA_REG_SPECIAL176
#define JLINK_XTENSA_REG_SPECIAL_EPC1         JLINK_XTENSA_REG_SPECIAL177
#define JLINK_XTENSA_REG_SPECIAL_EPC2         JLINK_XTENSA_REG_SPECIAL178
#define JLINK_XTENSA_REG_SPECIAL_EPC3         JLINK_XTENSA_REG_SPECIAL179
#define JLINK_XTENSA_REG_SPECIAL_EPC4         JLINK_XTENSA_REG_SPECIAL180
#define JLINK_XTENSA_REG_SPECIAL_EPC5         JLINK_XTENSA_REG_SPECIAL181
#define JLINK_XTENSA_REG_SPECIAL_EPC6         JLINK_XTENSA_REG_SPECIAL182
#define JLINK_XTENSA_REG_SPECIAL_EPC7         JLINK_XTENSA_REG_SPECIAL183
#define JLINK_XTENSA_REG_SPECIAL_DEPC         JLINK_XTENSA_REG_SPECIAL192
#define JLINK_XTENSA_REG_SPECIAL_EPS2         JLINK_XTENSA_REG_SPECIAL194
#define JLINK_XTENSA_REG_SPECIAL_EPS3         JLINK_XTENSA_REG_SPECIAL195
#define JLINK_XTENSA_REG_SPECIAL_EPS4         JLINK_XTENSA_REG_SPECIAL196
#define JLINK_XTENSA_REG_SPECIAL_EPS5         JLINK_XTENSA_REG_SPECIAL197
#define JLINK_XTENSA_REG_SPECIAL_EPS6         JLINK_XTENSA_REG_SPECIAL198
#define JLINK_XTENSA_REG_SPECIAL_EPS7         JLINK_XTENSA_REG_SPECIAL199
#define JLINK_XTENSA_REG_SPECIAL_HWCONFIG_ID1 JLINK_XTENSA_REG_SPECIAL208
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE1     JLINK_XTENSA_REG_SPECIAL209
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE2     JLINK_XTENSA_REG_SPECIAL210
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE3     JLINK_XTENSA_REG_SPECIAL211
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE4     JLINK_XTENSA_REG_SPECIAL212
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE5     JLINK_XTENSA_REG_SPECIAL213
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE6     JLINK_XTENSA_REG_SPECIAL214
#define JLINK_XTENSA_REG_SPECIAL_EXCSAVE7     JLINK_XTENSA_REG_SPECIAL215
#define JLINK_XTENSA_REG_SPECIAL_CPENABLE     JLINK_XTENSA_REG_SPECIAL224
#define JLINK_XTENSA_REG_SPECIAL_INTERRUPT    JLINK_XTENSA_REG_SPECIAL226
#define JLINK_XTENSA_REG_SPECIAL_INTSET       JLINK_XTENSA_REG_SPECIAL226
#define JLINK_XTENSA_REG_SPECIAL_INTCLEAR     JLINK_XTENSA_REG_SPECIAL227
#define JLINK_XTENSA_REG_SPECIAL_INTENABLE    JLINK_XTENSA_REG_SPECIAL228
#define JLINK_XTENSA_REG_SPECIAL_PS           JLINK_XTENSA_REG_SPECIAL230
#define JLINK_XTENSA_REG_SPECIAL_VECBASE      JLINK_XTENSA_REG_SPECIAL231
#define JLINK_XTENSA_REG_SPECIAL_EXCCAUSE     JLINK_XTENSA_REG_SPECIAL232
#define JLINK_XTENSA_REG_SPECIAL_DEBUGCAUSE   JLINK_XTENSA_REG_SPECIAL233
#define JLINK_XTENSA_REG_SPECIAL_CCOUNT       JLINK_XTENSA_REG_SPECIAL234
#define JLINK_XTENSA_REG_SPECIAL_PRID         JLINK_XTENSA_REG_SPECIAL235
#define JLINK_XTENSA_REG_SPECIAL_ICOUNT       JLINK_XTENSA_REG_SPECIAL236
#define JLINK_XTENSA_REG_SPECIAL_ICOUNTLEVEL  JLINK_XTENSA_REG_SPECIAL237
#define JLINK_XTENSA_REG_SPECIAL_EXCVADDR     JLINK_XTENSA_REG_SPECIAL238
#define JLINK_XTENSA_REG_SPECIAL_CCOMPARE0    JLINK_XTENSA_REG_SPECIAL240
#define JLINK_XTENSA_REG_SPECIAL_CCOMPARE1    JLINK_XTENSA_REG_SPECIAL241
#define JLINK_XTENSA_REG_SPECIAL_CCOMPARE2    JLINK_XTENSA_REG_SPECIAL242
#define JLINK_XTENSA_REG_SPECIAL_MISC0        JLINK_XTENSA_REG_SPECIAL244
#define JLINK_XTENSA_REG_SPECIAL_MISC1        JLINK_XTENSA_REG_SPECIAL245
#define JLINK_XTENSA_REG_SPECIAL_MISC2        JLINK_XTENSA_REG_SPECIAL246
#define JLINK_XTENSA_REG_SPECIAL_MISC3        JLINK_XTENSA_REG_SPECIAL247

//
// Debug registers for Xtensa cores, accessible via JLINK_WriteDebugReg() and JLINK_ReadDebugReg()
// Mainly pseudo-registers used to implement specific/csutom actions.
//
typedef enum {
  JLINK_XTENSA_DEBUG_REG_BREAK_IN = 0,           // (RW) Enable/Disable BreakIn
  JLINK_XTENSA_DEBUG_REG_BREAK_OUT,              // (RW) Enable/Disable BreakOut
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_PTR,         // (RW) Set/Get spill area pointer
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_SIZE,        // (RW) Set/Get spill area size
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_PRESERVE,    // (WO) Preserves spill area contents
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_RESTORE,     // (WO) Restores spill area contents
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_OPEN,        // (WO) Saves CPU registers and spill area contents. Sets <a4> to start of spill area.
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_CLOSE,       // (WO) Restores the spill area and CPU registers.
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_STORE_DIR0,  // (WO) Stores lower part of instruction into DIR0. Also increments internal <NumInst> counter. Next store is assumed to describe a new instruction
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_STORE_DIR1,  // (WO) Stores higher part of instruction (for instructions > 32-bit)
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_STORE_DIR2,  // (WO) Stores higher part of instruction (for instructions > 64-bit)
  JLINK_XTENSA_DEBUG_REG_SPILL_AREA_STORE_DIR3,  // (WO) Stores higher part of instruction (for instructions > 96-bit)
} JLINK_XTENSA_DEBUG_REG;
...
typedef enum {
  ...
  JLINK_ARM_V8AR_REG_AARCH32_FPSCR,     // Core-internally mapped to AArch64 register FPSR[31:0] but needs to be accessed differently in AArch32, so extra register in J-Link API
  ...
  //
  // FPU system registers AArch64
  //
  JLINK_ARM_V8AR_REG_FPEXC32_EL2,
  JLINK_ARM_V8AR_REG_MVFR0_EL1,
  JLINK_ARM_V8AR_REG_MVFR1_EL1,
  JLINK_ARM_V8AR_REG_MVFR2_EL1,
  //
  // FPU system registers AArch32
  //
  JLINK_ARM_V8AR_REG_AARCH32_FPEXC,  // Core-internally mapped to AArch64 register FPEXC32_EL2[31:0] but needs to be accessed differently in AArch32, so extra register in J-Link API
  JLINK_ARM_V8AR_REG_AARCH32_FPSID,  // Exists in AArch32 only. No AArch64 variant available
  JLINK_ARM_V8AR_REG_AARCH32_MVFR0,  // Core-internally mapped to AArch64 register MVFR0_EL1[31:0] but needs to be accessed differently in AArch32, so extra register in J-Link API
  JLINK_ARM_V8AR_REG_AARCH32_MVFR1,  // Core-internally mapped to AArch64 register MVFR1_EL1[31:0] but needs to be accessed differently in AArch32, so extra register in J-Link API
  JLINK_ARM_V8AR_REG_AARCH32_MVFR2,  // Core-internally mapped to AArch64 register MVFR2_EL1[31:0] but needs to be accessed differently in AArch32, so extra register in J-Link API
...
typedef struct {
  U32 SizeOfStruct;    // Set by caller. Evaluated by DLL.
  U32 IsValid;         // Set by callee (U32 to avoid struct stuffing).
                       // Indicates if control block is valid.
                       // If == 0, all following elements have to be assumed as "invalid".
  U64 Addr;            // Set by callee. Address of control block.
} JLINK_RTTERMINAL_CTRL_BLOCK_INFO;
...
typedef struct {
  const char* sName;
  const char* sDesc;
  U64         VirtAddr;     // Only used for 8051 targets so far, to map the different regions in the 4 GB address space
  U8          abDummy[16];  // Future use. Currently 0
} JLINK_MEM_ZONE_INFO;
...
typedef struct {
  U32 SizeOfStruct;           // Must be set by caller
  U8  SetBeforeOpen;          // Determines if this command string can be set before JLINK_Open() (1) or not (0)
  U8  SetAfterOpen;           // Determines if this command string can be set after  JLINK_Open() (1) or not (0)
} JLINK_CMD_STR_INFO;
...
typedef enum {
  ...
  ,JLINK_FLASHDL_FLASH_TYPE_SPI_EEPROM = 3 // SPI EEPROM
  ,JLINK_FLASHDL_NUM_FLASH_TYPES
...
typedef enum {
  ...
  JLINK_IFUNC_CORESIGHT_READ_ITEM_AP_SPACE,
  JLINK_IFUNC_CORESIGHT_READ_MEM_AP,
  JLINK_IFUNC_DEVICE_GET_LOADER_INFO,        // Internal use only (J-Flash for Flasher stand-alone preparation) See JLINK_FUNC_DEVICE_GET_LOADER_INFO typedef in JLINKARM_Const_Intern.h
  JLINK_IFUNC_EMU_GET_MAC_ADDR,
  JLINK_IFUNC_PCODE_COMPILE,                 // Internal use only (J-Flash for Flasher stand-alone preparation) See JLINK_FUNC_PCODE_COMPILE typedef in JLINKARM_Const_Intern.h
  JLINK_IFUNC_PCODE_INSTANCE_LOAD,           // Internal use only (J-Flash for Flasher stand-alone preparation) See JLINK_FUNC_PCODE_COMPILE typedef in JLINKARM_Const_Intern.h
  JLINK_IFUNC_PCODE_INSTANCE_UNLOAD,         // Internal use only (J-Flash for Flasher stand-alone preparation) See JLINK_FUNC_PCODE_COMPILE typedef in JLINKARM_Const_Intern.h
  JLINK_IFUNC_PCODE_INSTANCE_HAS_ENTRY,      // Internal use only (J-Flash for Flasher stand-alone preparation) See JLINK_FUNC_PCODE_COMPILE typedef in JLINKARM_Const_Intern.h
  JLINK_IFUNC_PCODE_INSTANCE_EXEC_FUNC,      // Internal use only (J-Flash for Flasher stand-alone preparation) See JLINK_FUNC_PCODE_COMPILE typedef in JLINKARM_Const_Intern.h
  JLINK_IFUNC_EMU_GET_NICKNAME,
  JLINK_IFUNC_EMU_SET_NICKNAME,
  JLINK_IFUNC_EXEC_GET_LIST,
  JLINK_IFUNC_EXEC_GET_INFO,
  JLINK_IFUNC_DEVICE_GET_FLASH_BANK_INFO,    // Internal use only (J-Flash for flash bank info) See JLINK_FUNC_DEVICE_GET_FLASH_BANK_INFO typedef in JLINKARM_Const_Intern.h
...
typedef int STDCALL JLINK_FUNC_CORESIGHT_READ_ITEM_AP_SPACE(U32 APBaseAddr, U32 Off, U32* pData);
typedef int STDCALL JLINK_FUNC_CORESIGHT_READ_MEM_AP(U32 APBaseAddr, U64 Addr, U32 NumItems, U32 Flags, void* pData);
typedef int STDCALL JLINK_FUNC_EMU_GET_MAC_ADDR(U8* pBuf, U32 NumBytes);
typedef int STDCALL JLINK_FUNC_EMU_GET_NICKNAME(char* pBuf, U32 NumBytes);
typedef int STDCALL JLINK_FUNC_EMU_SET_NICKNAME(const char* sNickname);
typedef int STDCALL JLINK_FUNC_EXEC_GET_LIST(const char** pasCmdStr, U32 MaxNumStr);
typedef int STDCALL JLINK_FUNC_EXEC_GET_INFO(const char* sCmdStr, JLINK_CMD_STR_INFO* pInfo);
...
*/
#define JLINKARM_TRACE_SOURCE_BUFFER       0
#define JLINKARM_TRACE_SOURCE_PINS         1
#define JLINKARM_TRACE_SOURCE_MTB          2             // Internally, same as JLINKARM_TRACE_SOURCE_BUFFER => TraceSource == on-chip trace buffer
#define JLINKARM_TRACE_SOURCE_SWO          3             // Same as JLINKARM_TRACE_SOURCE_PINS, but the data will be transferred over the SWO pin instead of the trace pins.
...
#define JLINKARM_RTTERMINAL_CMD_GETCTRLBLOCKINFO  5
...
#define JLINK_CORE_OLYMPUS                              JLINK_CORE_CORTEX_M85
...
#define JLINKARM_TRACE_SOURCE_ETM            JLINKARM_TRACE_SOURCE_PINS    // Backward compatibility define
#define JLINKARM_TRACE_SOURCE_ETB            JLINKARM_TRACE_SOURCE_BUFFER  // Backward compatibility define

#define JLINKARM_EMU_CAP_EX_SUPPORT_LPM_CPU   JLINKARM_EMU_CAP_EX_SUPPORT_ECO_CPU
#define JLINKARM_EMU_CAP_EX_SUPPORT_LPM_LOGIC JLINKARM_EMU_CAP_EX_SUPPORT_ECO_LOGIC
