...
#define SYS_SOCKET_IP_ADDR6_ANY         &SYS_IPAddr6_Any
#define SYS_SOCKET_IP_ADDR6_LOCALHOST   &SYS_IPAddr6_Localhost
...
#define SYS_SOCKET_ERR_ACCEPT_TIMEOUT   (-2)
...
extern const SYS_SOCKET_ADDR6 SYS_IPAddr6_Any;
extern const SYS_SOCKET_ADDR6 SYS_IPAddr6_Localhost;
...
// 
SYS_SOCKET_HANDLE     SYS_SOCKET_IPV6_OpenUDP         (void);
SYS_SOCKET_HANDLE     SYS_SOCKET_IPV6_OpenTCP         (void);
int                   SYS_SOCKET_IPV6_Connect         (SYS_SOCKET_HANDLE hSocket, const SYS_SOCKET_ADDR6* IPAddr, U32 Port);
int                   SYS_SOCKET_IPV6_Bind            (SYS_SOCKET_HANDLE hSocket, const SYS_SOCKET_ADDR6* IPAddr, U32 LocalPort);
int                   SYS_SOCKET_IPV6_SendTo          (SYS_SOCKET_HANDLE hSocket, const void* pData, U32 NumBytes, const SYS_SOCKET_ADDR6* pIPAddr, U32 DestPort);
...
int                   SYS_SOCKET_IPV6_GetNameInfo     (const SYS_SOCKET_ADDR6* pIPAddr, char* sHostname, U32 HostnameLen, char* sService, U32 ServiceLen);
int                   SYS_SOCKET_IPV6_ListenAtTCPAddr (SYS_SOCKET_HANDLE hSocket, const SYS_SOCKET_ADDR6* IPAddr, U32 Port, unsigned NumConnectionsQueued);
//
