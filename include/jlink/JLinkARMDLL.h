...
JLINKARMDLL_API U32                         JLINKARM_ReadReg                  (U32 RegIndex);
JLINK_API       U32               STDCALL   JLINK_ReadReg                     (U32 RegIndex);
...
JLINKARMDLL_API char                        JLINKARM_WriteReg                 (U32 RegIndex, U32 Data);
JLINK_API       char              STDCALL   JLINK_WriteReg                    (U32 RegIndex, U32 Data);
...
JLINK_API       const char*       STDCALL   JLINK_DEVICE_GetLoaderName        (U32 DeviceIndex, U64 FlashBankBaseAddr, U32 LoaderIndex);
...
JLINK_API       int               STDCALL   JLINK_WriteZonedU64_64            (U64 Addr, U64 Data, const char* sZone);
...
//
// Implicit API calls only available via J-Link import library or JLINK_GetpFunc()
// They are NOT exported symbols of the DLL but only of the J-Link import library.
//
JLINK_API       int               STDCALL   JLINK_CORESIGHT_ReadItemAPSpace  (U32 APBaseAddr, U32 Off, U32 * pData);                           // See JLINK_FUNC_CORESIGHT_READ_ITEM_AP_SPACE
JLINK_API       int               STDCALL   JLINK_CORESIGHT_ReadMemAP        (U32 APBaseAddr, U64 Addr, U32 NumItems, U32 Flags, void* pData); // See JLINK_FUNC_CORESIGHT_READ_MEM_AP
